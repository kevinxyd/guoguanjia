...
public class WorkOrderProvider {
    ...
    public String selectByCondition(Map<String,Object> params){
        ...
        sb.append("select  wo.*,cu.name createUserName,tu.name transportUserName,ru.name recipientUserName,co.name createOfficeName from  work_order wo " +
                ...
                "LEFT JOIN  sys_office tro       on  tu.office_id=tro.id " +
